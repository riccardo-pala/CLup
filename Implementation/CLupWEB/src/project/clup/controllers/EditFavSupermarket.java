 ...
 */
@WebServlet("/EditFavSupermarket")
public class EditFavSupermarket extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer favSupermarketId = null;
		try {
			favSupermarketId = Integer.parseInt(request.getParameter("favsupermarketid"));
		...
		if(userPersisted == null) {
			...
			try {
				user = router.forwardProfileUpdateRequest(userPersisted.getUsername(), null, null, null, null, favSupermarketId);
